...
namespace Blockchain
{
    ...
    {
        private ConcurrentBag<ITransaction> openTransactions = new ConcurrentBag<ITransaction>();
        private ConcurrentBag<Block> unpublishedBlocks = new ConcurrentBag<Block>();
